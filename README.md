...
27. Стоит продумать структуру проекта. Как минимальный вариант создать папку components и туда поместить все компоненты. Также для каждого компонента лучше создавать папку **ComponentName**, в которой находятся файлы **ComponentName.tsx**, **ComponentName.css** и **index.ts**.
